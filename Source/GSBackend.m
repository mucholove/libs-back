...
+ (void) initializeBackend;
@end
#elif BUILD_SERVER == SERVER_headless_server
#include <headless_server/HLSServer.h>
@interface HLSServer (Initialize)
+ (void) initializeBackend;
@end
#endif
...
#if (BUILD_GRAPHICS==GRAPHICS_headless)
    context = @"HLContext";
#elif (BUILD_GRAPHICS==GRAPHICS_xdps)
